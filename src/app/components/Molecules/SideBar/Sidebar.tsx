...
const Sidebar: React.FC = (props) => {
  ...
  return (
    <nav className="sticky top-0 mr-10 hidden h-[100vh] w-1/12 flex-col items-end justify-between py-6 md:flex lg:basis-1/3 lg:items-end lg:pr-20">
      <div className="flex h-full flex-col justify-between">
        <div className="flex flex-col items-start gap-8">
          <ul className="flex w-full flex-col items-start gap-4 text-lg">
            <SquabbleLogo customize="lg:ml-2 mb-4" textClass="hidden" />
